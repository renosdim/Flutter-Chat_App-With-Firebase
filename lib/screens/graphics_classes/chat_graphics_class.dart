...
class ChatGraphicsClassAttributes{
  ...
  const ChatGraphicsClassAttributes(  {this.messageAlreadyReadFormat=const MessageAlreadyRead1(),
    ...
    this.scrollingAndRefreshingFormat = const RegularRefreshScroll()
...
class ChatGraphicsClass extends InheritedWidget{
  ...
  const ChatGraphicsClass(  {super.key, required this.messageAlreadyReadFormat,
    required this.userNameInsteadOfName,
    required this.picWidgetFormat,
    ...
    required this.scrollingAndRefreshingFormat, required super.child
